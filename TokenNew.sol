...
//import "https://gateway.pinata.cloud/ipfs/QmPgU3FyDBkrrJwXp8BKf1Rxu8R3aVKmwDTQE44hV2jGe7"
import   "./PerformanceTasks.sol";

// All subsequent code will be inside this block

 contract Token {
    Manager manager;
    string public name = "TokenNew"; // Holds the name of the token
    string public symbol = "TkN"; // Holds the symbol of the token
